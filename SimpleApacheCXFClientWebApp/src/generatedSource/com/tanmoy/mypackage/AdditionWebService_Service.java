 ...
 * 2016-11-14T19:49:28.514+05:30
 * Generated source version: 3.1.8
 * 
 */
@WebServiceClient(name = "AdditionWebService", 
                  wsdlLocation = "file:/D:/git clone/SOAP-Web-Service-Projects/SimpleApacheCXFClientWebApp/src/main/resources/wsdl/hello.wsdl",
...
public class AdditionWebService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/git clone/SOAP-Web-Service-Projects/SimpleApacheCXFClientWebApp/src/main/resources/wsdl/hello.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AdditionWebService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/git clone/SOAP-Web-Service-Projects/SimpleApacheCXFClientWebApp/src/main/resources/wsdl/hello.wsdl");
        }
        WSDL_LOCATION = url;
    }
