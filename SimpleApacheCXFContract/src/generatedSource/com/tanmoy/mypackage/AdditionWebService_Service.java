 ...
 * 2016-11-14T15:15:11.957+05:30
 * Generated source version: 3.1.8
 * 
 */
@WebServiceClient(name = "AdditionWebService", 
                  wsdlLocation = "file:/E:/Spring Tutorials/eclipse_workspace_webservices/SimpleApacheCXFContract/src/main/resources/wsdl/hello.wsdl",
...
public class AdditionWebService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Spring Tutorials/eclipse_workspace_webservices/SimpleApacheCXFContract/src/main/resources/wsdl/hello.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AdditionWebService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/Spring Tutorials/eclipse_workspace_webservices/SimpleApacheCXFContract/src/main/resources/wsdl/hello.wsdl");
        }
        WSDL_LOCATION = url;
    }
